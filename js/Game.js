class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 120, y: height - 1200, image: obstacle2Image },
      { x: width / 2 + 350, y: height - 1900, image: obstacle2Image },
      { x: width / 2 - 120, y: height - 3200, image: obstacle2Image },
     
      { x: width / 2 - 200, y: height - 4250, image: obstacle2Image },
      { x: width / 2 - 10, y: height - 5250, image: obstacle2Image },
    ];
